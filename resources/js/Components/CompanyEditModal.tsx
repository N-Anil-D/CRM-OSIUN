...
const CompanyEditModal = () => {
    const [fieldOne, setFieldOne] = useState<boolean>(true);
    const [fieldTwo, setFieldTwo] = useState<boolean>();
    const [fieldThree, setFieldThree] = useState<boolean>();
    const [fieldFour, setFieldFour] = useState<boolean>();
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header header-border justify-content-between p-0">
                            <h5 className="modal-title">Edit New Company</h5>
                            <button
                                type="button"
                                                ...
                                                >
                                                    <div className="people-select-tab">
                                                        ...
                                                        <div className="select-people-checkbox">
                                                            <label className="custom_check">
                                                                ...
                                                                <span className="people-profile">
                                                                    <Link href="#">Darlee Robertson</Link>
                                                                </span>
                                                            </label>
                                                        </div>
                                                        <div className="select-people-checkbox">
                                                        ...
                                                        <div className="select-confirm-btn">
                                                            <Link href="#" className="btn danger-btn">
                                                                Confirm
                                                            </Link>
                                                        </div>
                                                    </div>
                        ...
                        <div className="modal-body">
                            <div className="success-message text-center">
                                ...
                                <div className="col-lg-12 text-center form-wizard-button">
                                    <Link href="#" className="button btn-lights" data-bs-dismiss="modal">
                                        Close
                                    </Link>
