                        ...
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    ...
                                    >
                                        Dashboard (Aga deniyoruz da bakalım nereye çıkacağız :))
                                    </Link>
                                ) : (
                                    <>
                                        <Link
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        <div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                <h2 className="text-xl font-semibold text-black dark:text-white">Documentation (Aga deniyoruz da bakalım nereye çıkacağız :))</h2>
