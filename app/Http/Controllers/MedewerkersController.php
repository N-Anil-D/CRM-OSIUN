    ...
    public function store(Request $request)
    {
        try {
            $newMedewerker = medewerkers::create([
                ...
                'date_of_birth' => Carbon::parse($request->input('date_of_birth'))->format('Y-m-d'), // Doğru tarih formatı
                ...
                'personnel_number' => $request->input('personnel_number'),
            ...
            return response()->json($newMedewerker, 200);
